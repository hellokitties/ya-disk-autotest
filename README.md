...
**Локальный запуск:**
1. Установить токен для авторизации в переменную среды OAUTH_TOKEN. Получение токена описано [в инструкции](https://yandex.ru/dev/disk-api/doc/ru/concepts/quickstart)
